...
use anthropic_agent_sdk::control::{
    ControlMessage, ControlRequest, ControlResponse, InitResponse, ProtocolHandler,
};
use anthropic_agent_sdk::types::{HookEvent, PermissionRequest, RequestId, ToolName};
use tokio::sync::mpsc;
...
async fn test_protocol_initialization() {
    ...
    let init_response = InitResponse {
        ...
        capabilities: anthropic_agent_sdk::control::protocol::ServerCapabilities {
            streaming: true,
            tools: true,
            mcp: true,
        },
...
async fn test_permission_response_creation() {
    ...
    let result = anthropic_agent_sdk::types::PermissionResult::Allow(
        anthropic_agent_sdk::types::PermissionResultAllow {
            updated_input: None,
...
async fn test_permission_channel_integration() {
    ...
    let perm_request = PermissionRequest {
        ...
        context: anthropic_agent_sdk::types::ToolPermissionContext::new(vec![]),
    };
